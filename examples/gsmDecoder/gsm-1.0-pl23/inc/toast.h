...
/* In embedded Keil environment, sys/types.h and sys/stat.h are not available */
/* Skip these includes - we'll define the necessary macros below */
...
/* Define S_ISREG and related macros for embedded environments */
#ifndef S_IFREG
