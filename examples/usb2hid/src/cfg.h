...
/*
 * Demo Selection (choose exactly one)
 ****************************************************************************************
 */

/// HID Boot device demo (keyboard + mouse with boot protocol)
#define DEMO_HID_BOOT       (0)

/// HID Custom device demo (keyboard + raw bidirectional HID)
...
/*
 * HID Boot Demo Configuration
 ****************************************************************************************
 */

#if (DEMO_HID_BOOT)
/// Enable physical button/LED interaction (0=auto-circle test, 1=button scan)
#define USE_KEYS            (0)
#endif
