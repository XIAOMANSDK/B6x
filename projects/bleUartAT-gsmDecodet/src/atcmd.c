...
// flag: All_FACTORY_REST:  Full factory reset
// flag: PAIR_FACTORY_RESET: Clear pairing info
...
//        sys_config.rssi = 0;                      // RSSI signal value
...
//    {
//        //sprintf((char*)sys_config.pass, "000000");      // Password
...
//    GAPBondMgr_SetParameter( GAPBOND_ERASE_ALLBONDS, 0, NULL ); // Clear pairing info
