...
//    PT_RSP_INVALID_PACKET         = 0x0F, // HCI 包格式错误
    ...
    PT_RSP_NTFIND_RES             = 0x2A, // 服务通知属性开关使能指示
...
enum PAYL_LEN
{
    ...
    PLEN_RSP_NTFIND               = 0x04,  // 2uuids+2status
};
...
void pt_rsp_ntfind_res(uint16_t handle, uint16_t status);
