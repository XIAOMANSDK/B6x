...
// msbc语音report接口；index值：0=RPT_IDX_FEATURE2_INPUT，1=RPT_IDX_FEATURE2_INPUT，2=RPT_IDX_FEATURE2_INPUT；len为60
int pt_hid_voice_report_send(uint8_t index, const uint8_t *buffer, uint16_t len);
