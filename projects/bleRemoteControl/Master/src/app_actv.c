...
//            }
            ...
            if (/*(icon == GAP_APPEARANCE_HID_KEYBOARD) && */(ad_type == GAP_AD_TYPE_SHORTENED_NAME) && (*p_cursor == 6) && (0 == memcmp(p_cursor+2, "MI RC", 5)))
            {
