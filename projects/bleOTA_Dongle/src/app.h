...
#define APP_SUBTASK_HANDLER(sub)                                                                   \
    int app_##sub##_handler(msg_id_t msgid, const void *param, task_id_t dest_id, task_id_t src_id)

#define APP_MSG_HANDLER(msg)                                                                       \
    static void app_##msg##_handler(                                                               \
        msg_id_t msgid, struct msg const *param, task_id_t dest_id, task_id_t src_id)

#define APP_MSG_HANDLER_T(msg)                                                                     \
    static void app_##msg##_handler(                                                               \
        msg_id_t msgid, const void *param, task_id_t dest_id, task_id_t src_id)
