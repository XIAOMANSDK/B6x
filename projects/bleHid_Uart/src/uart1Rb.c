...
#define UART1_DMA_INT       (0x01UL << UART1_DMA_CHAN)
#undef  UART1_RBUF_SIZE
#define UART1_RBUF_SIZE     0x300
#endif
...
__ATTR_SRAM static rbuf_t uart1RbRx;
...
{
    dma_chnl_ctrl(UART1_DMA_CHAN, CHNL_DIS);
    DMA_UARTx_RX_CONF(UART1_DMA_CHAN, 1, uart1RbRx.data, RBUF_HALF_SIZE, CCM_STOP);
}
