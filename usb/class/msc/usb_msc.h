 ...
 * @file usb_msc.h
 *
 * @brief  Mass Storage Class (MSC) public header
 *
 * Header follows Device Class Definition for Mass Storage Class (MSC)
 ****************************************************************************************
 */
...
/** MSC Command Block Wrapper (CBW) Signature 'USBC' */
#define MSC_CBW_Signature           0x43425355
/** MSC Command Status Wrapper (CSW) Signature 'USBS' */
