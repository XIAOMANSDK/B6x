 ...
 * - USB Class Definition for Audio Devices (audio10.pdf and audio20_final.pdf)
...
#define AUDIO_PROTOCOL_V2                   0x20 /* IP version 2.0 */
...
/* Encoder Error Codes(<0: Reserved for vendor extensions, >13: Reserved) */
...
#define AUDIO_SIZEOF_AC_SELECTOR_UNIT_DESC      (7)
...
/* Interface Association Descriptor */
#define AUDIO_AC_ASSOCIATION_INTF(bFirstInterface, bInterfaceCount)                     \
    0x08,                                                                               \
    USB_DESC_TYPE_INTERFACE_ASSOCIATION,                                                \
    bFirstInterface,                                                                    \
    bInterfaceCount,                                                                    \
...
#define AUDIO_AC_ASSOCIATION_INTF_LEN           (0x08)

/* AudioControl Interface */
#define AUDIO_AC_HEADER_INIT(bInterfaceNumber, wTotalLength, stridx, ...) \
    0x09,                            /* bLength */                                      \
    USB_DESC_TYPE_INTERFACE,         /* bDescriptorType */                              \
...
#define AUDIO_AC_HEADER_INIT_LEN(n)             (0x09 + 0x08 + n)
...
#define AUDIO_AC_OUTPUT_TERMINAL_DESCRIPTOR_INIT(bTerminalID, wTerminalType, bAssocTerminal, bSourceID) \
    0x09,                            /* bLength */                                      \
    AUDIO_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */                              \
    AUDIO_CONTROL_OUTPUT_TERMINAL,   /* bDescriptorSubtype */                           \
    bTerminalID,                     /* bTerminalID */                                  \
    WBVAL(wTerminalType),            /* wTerminalType : USB Streaming */                \
    bAssocTerminal,                  /* bAssocTerminal 0x00 */                          \
    bSourceID,                       /* bSourceID */                                    \
    0x00                             /* iTerminal */

#define AUDIO_AC_SELECTOR_UNIT_DESCRIPTOR_INIT(bUnitID, baSourceID, bNrInPins)          \
    0x07,                            /* bLength */                                      \
    AUDIO_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */                              \
...
#define AUDIO_AS_DESCRIPTOR_INIT(bInterfaceNumber, bTerminalLink, bNrChannels, bSubFrameSize, bBitResolution, bEndpointAddress, bmAttributes, wMaxPacketSize, bInterval, ...) \
    ...
    bNrChannels,                     /* bNrChannels */                                          \
    bSubFrameSize,                   /* bSubFrameSize : 2 Bytes per audio subframe */           \
    bBitResolution,                  /* bBitResolution : 16 bits per sample */                  \
    ...
    bmAttributes,                    /* 0x01 bmAttributes */                                    \
...
/* Interface Association Descriptor */
#define AUDIO_V2_AC_ASSOCIATION_INTF(bFirstInterface, bInterfaceCount)                  \
    0x08,                                                                               \
    USB_DESC_TYPE_INTERFACE_ASSOCIATION,                                                \
    bFirstInterface,                                                                    \
    bInterfaceCount,                                                                    \
...
#define AUDIO_V2_AC_ASSOCIATION_INTF_LEN        (0x08)

/* AudioControl Interface */
#define AUDIO_V2_AC_HEADER_INIT(bInterfaceNumber, wTotalLength, bCategory, bmControls, stridx) \
    0x09,                            /* bLength */                                      \
    USB_DESC_TYPE_INTERFACE,         /* bDescriptorType */                              \
    bInterfaceNumber,                /* bInterfaceNumber */                             \
    0x00,                            /* bAlternateSetting */                            \
    ...
    USB_DEVICE_CLASS_AUDIO,          /* bInterfaceClass */                              \
    AUDIO_SUBCLASS_AUDIOCONTROL,     /* bInterfaceSubClass */                           \
    AUDIO_PROTOCOL_V2,               /* bInterfaceProtocol */                           \
    stridx,                          /* iInterface */                                   \
    0x09,                            /* bLength */                                      \
    AUDIO_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */                              \
    AUDIO_CONTROL_HEADER,            /* bDescriptorSubtype */                           \
...
#define AUDIO_V2_AC_HEADER_INIT_LEN             (0x09 + 0x09)
...
#define AUDIO_SAMPLE_FREQ_4B(frq)           (uint8_t)(frq), (uint8_t)((frq >> 8)), (uint8_t)((frq >> 16)), (uint8_t)((frq >> 24))
