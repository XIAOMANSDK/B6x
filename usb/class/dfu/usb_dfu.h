 ...
 * @file usb_dfu.h
 *
 * @brief  USB Device Firmware Upgrade (DFU) class definitions
 *
 * Header follows [USB Device Firmware Upgrade Specification, Revision 1.1]
...
/** DFU Specification release v1.1 */
#define DFU_VERSION                     0x0110

/** DFU Class Subclass */
#define DFU_SUBCLASS_DFU                0x01

/** DFU Class Protocol: runtime/dfu mode */
...
#define DFU_ATTR_MANIFEST_TOL           0x04
